...
pacstrap /mnt base linux linux-firmware acpi acpid networkmanager base-devel git vim sudo grub os-prober efibootmgr wget htop tmux openssh ranger tlp acpi_call man ntfs-3g xorg-server xorg-xinit xorg-xrandr xorg-xsetroot xorg-xbacklight arandr picom feh libxinerama noto-fonts noto-fonts-cjk noto-fonts-emoji pulseaudio pavucontrol pamixer scrot dunst libnotify xdg-utils xf86-video-intel task lxappearance zathura zathura-cb zathura-pdf-mupdf cmus mpv udisks2 transmission-cli youtube-dl firefox pass pass-otp sxiv zbar w3m maim ||
exit 1
